...
-- BASELINE MIGRATION
-- ============================================================================
-- This file is a byte-for-byte copy of ../schema.sql, the script that was
-- actually run by hand against the live project (via the Supabase SQL
-- Editor) to create all 8 tables. It's captured here, under
-- supabase/migrations/, as the starting point for the project's migration
-- history going forward — NOT re-run automatically by this baseline's
-- presence. See CLAUDE.md's "Database changes" section for the workflow any
-- future schema change follows: a new migration file, reviewed here, applied
-- to the live database only with explicit approval each time.
-- ============================================================================
--
-- ============================================================================
